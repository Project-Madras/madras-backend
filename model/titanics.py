...
class User(db.Model):
    ...
    def __init__(
        self, name, uid, password="123qwerty", dob=date.today(), hashmap={}, role="User"
    ):
...
def initUsers():
    with app.app_context():
        ...
        u1 = User(
            ...
            password="123toby",
            dob=date(1847, 2, 11),
            hashmap={"job": "inventor", "company": "GE"},
            role="Admin",
        )
        u2 = User(
            name="Nicholas Tesla",
            ...
            password="123niko",
            dob=date(1856, 7, 10),
            hashmap={"job": "inventor", "company": "Tesla"},
        )
        u3 = User(
            name="Alexander Graham Bell",
            uid="lex",
            hashmap={"job": "inventor", "company": "ATT"},
        )
        u4 = User(
            name="Grace Hopper",
            uid="hop",
            password="123hop",
            dob=date(1906, 12, 9),
            hashmap={"job": "inventor", "company": "Navy"},
        )
        users = [u1, u2, u3, u4]
